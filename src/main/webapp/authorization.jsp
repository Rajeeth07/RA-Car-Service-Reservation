...
<%
	...
	// Retrieve the 'session_state' parameter from the URL
	    ...
	    try {
	        InputStream inputStream = application.getResourceAsStream("/application.properties");
...
<body>
    <script type="text/javascript">
        ...
        function makePostRequest() {
            ...
            var redirect_uri =  '<%= properties.getProperty("redirect_uri") %>';
           ...
           // const clientCredentials = btoa(`${client_Id}:${client_secret}`);
            ...
            $.ajax(url, requestOptions)
                .done(function (data) {
            	    ...
            	    window.location.href = "\profileInfo.jsp";
